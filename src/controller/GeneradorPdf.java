...
public class GeneradorPdf {
     ...
     * @throws IOException  es la io exception
     * @throws SQLException es la sql exception
     */
    public static void generarFactura(int idPedido) throws IOException, SQLException {
